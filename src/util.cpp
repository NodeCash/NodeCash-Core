...
int nAnonymizeNodeCashAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\NodeCash
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\NodeCash
    // Mac: ~/Library/Application Support/NodeCash
    // Unix: ~/.NodeCash
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "NodeCash";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "nodecash.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "nodecashd.pid"));

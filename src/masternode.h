...
#define TIERED_MASTERNODES_START_BLOCK         14400// tiered mns 1st block
...
// Masternode tiers
static std::map<int, int> masternodeTiers = map_list_of (1, 2000) (2, 4000) (3, 8000) (4, 16000) (5, 24000); // 2000 - 4000 - 8000 - 16000 － 24000

// Masternode tier rewards
static std::map<int, int> masternodeTierRewards = map_list_of (1, 20) (2, 45) (3, 100) (4, 240) (5, 360); // 20 - 45 - 100 - 240 － 360

//
// The Masternode Class. For managing the darksend process. It contains the input of the 1000 NDH, signature to prove

...
const string strMessageMagic = "NodeCash Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight <= 30) {
        nSubsidy = 120000 * COIN; //Premined 36M
    } else {
        nSubsidy = 1 * COIN;
    }
...
static int64_t nTargetTimespan = 10 * 60;  // 5 mins
